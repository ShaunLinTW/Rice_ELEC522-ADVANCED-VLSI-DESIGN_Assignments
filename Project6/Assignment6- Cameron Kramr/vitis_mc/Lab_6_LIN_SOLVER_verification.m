...
B = [0.69999; 0.44665; 0.33501; 0.26967];
%{
...
Bin_1 = timeseries(B(1));
Bin_2 = timeseries(B(2));
Bin_3 = timeseries(B(3));
Bin_4 = timeseries(B(4));
...
C = [getdatasamples(sim_out.C_1, sim_length); getdatasamples(sim_out.C_2, sim_length); getdatasamples(sim_out.C_3, sim_length); getdatasamples(sim_out.C_4, sim_length)];

target_mat
C
R

Product = target_mat*C
