...
$(ObjDir)/basic_cordic_tb.cpp_pre.cpp.tb.o : basic_cordic_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling basic_cordic_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/basic_cordic.cpp_pre.cpp.tb.o : basic_cordic.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling basic_cordic.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
