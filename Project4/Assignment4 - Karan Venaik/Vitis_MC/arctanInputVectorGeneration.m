...
xCartesian = 1*rand(1,testVectorLength);
fill = zeros(size(xCartesian,1), testVectorLength-length(xCartesian));
...
yCartesian = 1*rand(1,testVectorLength);
fill = zeros(size(yCartesian,1), testVectorLength-length(yCartesian));
