; ModuleID = 'C:/ELEC522/venaik/Project4/Vitis_HLS/cordic/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_cordic_ir(i1 zeroext %cordicMode, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nocapture readonly %targetAnglePhi, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nocapture readonly %xCartesian, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nocapture readonly %yCartesian, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull dereferenceable(2) %arctan, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull dereferenceable(2) %s, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull dereferenceable(2) %c) local_unnamed_addr #0 {
entry:
  %arctan_copy = alloca i16, align 512
  %s_copy = alloca i16, align 512
  %c_copy = alloca i16, align 512
  call fastcc void @copy_in(%"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nonnull %arctan, i16* nonnull align 512 %arctan_copy, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nonnull %s, i16* nonnull align 512 %s_copy, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* nonnull %c, i16* nonnull align 512 %c_copy)
  call void @apatb_cordic_hw(i1 %cordicMode, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %targetAnglePhi, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %xCartesian, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %yCartesian, i16* %arctan_copy, i16* %s_copy, i16* %c_copy)
  call void @copy_back(%"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %arctan, i16* %arctan_copy, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %s, i16* %s_copy, %"struct.ap_fixed<16, 3, AP_TRN, AP_WRAP, 0>"* %c, i16* %c_copy)
  ret void
}
