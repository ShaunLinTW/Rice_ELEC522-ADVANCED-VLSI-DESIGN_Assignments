...
// wrapc file define:
#define AUTOTB_TVIN_state "../tv/cdatafile/c.cordic.autotvin_state.dat"
#define AUTOTB_TVOUT_state "../tv/cdatafile/c.cordic.autotvout_state.dat"
...
#define AUTOTB_TVIN_t "../tv/cdatafile/c.cordic.autotvin_t.dat"
#define AUTOTB_TVOUT_t "../tv/cdatafile/c.cordic.autotvout_t.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_state "../tv/rtldatafile/rtl.cordic.autotvout_state.dat"
...
#define AUTOTB_TVOUT_PC_t "../tv/rtldatafile/rtl.cordic.autotvout_t.dat"
...
extern "C" void apatb_cordic_hw(char __xlx_apatb_param_state, __cosim_s2__* __xlx_apatb_param_theta, __cosim_s2__* __xlx_apatb_param_x, __cosim_s2__* __xlx_apatb_param_y, volatile void * __xlx_apatb_param_s, volatile void * __xlx_apatb_param_c, volatile void * __xlx_apatb_param_t) {
...
((char*)__xlx_apatb_param_c)[0*2+1] = c_pc_buffer[0].range(15, 8).to_int64();
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_t);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<16> > t_pc_buffer(1);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
            ...
            // push token into output port buffer
            if (AESL_token != "") {
              t_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "t" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {((char*)__xlx_apatb_param_t)[0*2+0] = t_pc_buffer[0].range(7, 0).to_int64();
((char*)__xlx_apatb_param_t)[0*2+1] = t_pc_buffer[0].range(15, 8).to_int64();
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
aesl_fh.write(AUTOTB_TVIN_state, formatData(pos, 1));
}
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_t;
aesl_fh.write(AUTOTB_TVIN_t, formatData(pos, 16));
}
...
cordic_hw_stub_wrapper(__xlx_apatb_param_state, __xlx_apatb_param_theta, __xlx_apatb_param_x, __xlx_apatb_param_y, __xlx_apatb_param_s, __xlx_apatb_param_c, __xlx_apatb_param_t);
...
// print t Transactions
{
aesl_fh.write(AUTOTB_TVOUT_t, begin_str(AESL_transaction));
{
auto *pos = (unsigned char*)__xlx_apatb_param_t;
aesl_fh.write(AUTOTB_TVOUT_t, formatData(pos, 16));
}
  tcl_file.set_num(1, &tcl_file.t_depth);
aesl_fh.write(AUTOTB_TVOUT_t, end_str());
}
