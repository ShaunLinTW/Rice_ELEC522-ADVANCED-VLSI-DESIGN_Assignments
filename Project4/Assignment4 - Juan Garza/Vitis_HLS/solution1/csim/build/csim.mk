...
HLS_SOURCES = ../../../../cordic-top.cpp ../../../../cordic.cpp
...
$(ObjDir)/cordic-top.o: ../../../../cordic-top.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../cordic-top.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/cordic-top.d
