...
#pragma HLS INTERFACE s_axilite port=state bundle=HLS_TREEADD_PERIPH_BUS
...
#pragma HLS INTERFACE s_axilite port=s bundle=HLS_TREEADD_PERIPH_BUS
#pragma HLS INTERFACE s_axilite port=c bundle=HLS_TREEADD_PERIPH_BUS
#pragma HLS INTERFACE s_axilite port=t bundle=HLS_TREEADD_PERIPH_BUS
