...
HLS_SOURCES = ../../../../../code/cordic_test.cpp ../../../../../code/cordic.cpp
...
$(ObjDir)/cordic_test.o: ../../../../../code/cordic_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../code/cordic_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/cordic_test.d

$(ObjDir)/cordic.o: ../../../../../code/cordic.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../code/cordic.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
